...
class Student(SQLModel, table=True):
    ...
    tel1: str = Field(..., max_length=9, nullable=False)
    tel2: str = Field(..., max_length=9, nullable=False)

    qrcode: Optional[int] = Field(default=None, nullable=False, foreign_key="qrcode.id")
