"""
Formation Type Table Model

Defines the `Formation Type` table with core fields and validation logic.
"""
...
class FormationTypeModel(BaseModel):
    label: str
...
class FormationType(SQLModel, table=True):
